...
class DSM_CardCarousel_Child extends ET_Builder_Module {
		...
		return array(
			'fonts'           => array(
				'badge'   => array(
					...
					'css'            => array(
						'main' => '.dsm_card_carousel %%order_class%% .dsm_card_carousel_child_badge_text',
					),
					'font_size'      => array(
						'default' => '12px',
					),
				...
				'header'  => array(
					...
					'css'            => array(
						'main' => ".dsm_card_carousel {$this->main_css_element} h4, .dsm_card_carousel {$this->main_css_element} h4 a, .dsm_card_carousel {$this->main_css_element} h1.et_pb_module_header, .dsm_card_carousel {$this->main_css_element} h1.et_pb_module_header a, .dsm_card_carousel {$this->main_css_element} h2.et_pb_module_header, .dsm_card_carousel {$this->main_css_element} h2.et_pb_module_header a, .dsm_card_carousel {$this->main_css_element} h3.et_pb_module_header, .dsm_card_carousel {$this->main_css_element} h3.et_pb_module_header a, .dsm_card_carousel {$this->main_css_element} h5.et_pb_module_header, .dsm_card_carousel {$this->main_css_element} h5.et_pb_module_header a, .dsm_card_carousel {$this->main_css_element} h6.et_pb_module_header, .dsm_card_carousel {$this->main_css_element} h6.et_pb_module_header a",
					),
					'font_size'      => array(
						'default' => '26px',
					),
				...
				'body'    => array(
					...
					'css'            => array(
						'main'        => ".dsm_card_carousel {$this->main_css_element} .dsm_card_carousel_child_description",
						'line_height' => ".dsm_card_carousel {$this->main_css_element} .dsm_card_carousel_child_description p",
						'text_align'  => ".dsm_card_carousel {$this->main_css_element} .dsm_card_carousel_child_description",
						'text_shadow' => ".dsm_card_carousel {$this->main_css_element} .dsm_card_carousel_child_description",
					),
				...
				'subhead' => array(
					...
					'css'            => array(
						'main' => '.dsm_card_carousel %%order_class%% .dsm_card_carousel_child_subtitle',
					),
					'line_height'    => array(
						'default' => '1em',
					),
			...
			'borders'         => array(
				'default' => array(
					'css' => array(
						'main' => array(
							'border_radii'  => ".dsm_card_carousel {$this->main_css_element}.dsm_card_carousel_child.swiper-slide>div:first-of-type",
							'border_styles' => ".dsm_card_carousel {$this->main_css_element}.dsm_card_carousel_child.swiper-slide>div:first-of-type",
						),
					),
				),
				'image'   => array(
					'css'          => array(
						'main' => array(
							'border_radii'  => '.dsm_card_carousel %%order_class%% .dsm_card_carousel_child_image_wrapper',
							'border_styles' => '.dsm_card_carousel %%order_class%% .dsm_card_carousel_child_image_wrapper',
						),
					),
				...
				'badge'   => array(
					'css'          => array(
						'main' => array(
							'border_radii'  => ".dsm_card_carousel {$this->main_css_element} .dsm_card_carousel_child_badge_text",
							'border_styles' => ".dsm_card_carousel {$this->main_css_element} .dsm_card_carousel_child_badge_text",
						),
					),
					'defaults'     => array(
			...
			'box_shadow'      => array(
				'default' => array(
					'css' => array(
						'main' => ".dsm_card_carousel {$this->main_css_element}.dsm_card_carousel_child.swiper-slide>div:first-of-type",
					),
				),
				'image'   => array(
					...
					'toggle_slug'       => 'image_settings',
					'css'               => array(
						'main' => ".dsm_card_carousel {$this->main_css_element} .dsm_card_carousel_child_image_wrapper",
					),
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		$image_selector            = '.dsm_card_carousel %%order_class%% .dsm_card_carousel_child_image_wrapper';
		$image_background_selector = '.dsm_card_carousel %%order_class%% .dsm_card_carousel_child_image_background';
		$badge_selector            = '.dsm_card_carousel %%order_class%% .dsm_card_carousel_child_badge_text';
		$content_wrapper_selector  = '.dsm_card_carousel %%order_class%% .dsm_card_wrapper';

		// Transition Child.
		ET_Builder_Element::set_style(
			$render_slug,
			array(
				'selector'    => '.dsm_card_carousel %%order_class%% .dsm_card_carousel_child>div:first-of-type, .dsm_card_carousel %%order_class%% .dsm_card_carousel_child_badge_text',
				'declaration' => sprintf(
		...
		if ( 'on' === $is_overlay_applied ) {
			...
			et_pb_generate_responsive_css( $font_size_values, '%%order_class%% .et_overlay:before', 'font-size', $render_slug );

			if ( et_builder_is_hover_enabled( 'icon_font_size', $this->props ) ) {
				ET_Builder_Element::set_style(
					$render_slug,
					array(
						'selector'    => $this->add_hover_to_order_class( '%%order_class%% .et_overlay:before' ),
						'declaration' => sprintf(
							'font-size: %1$s;',
		...
		if ( $badge_custom_position === 'on' ) {
			...
			et_pb_generate_responsive_css( $badge_left_position_values, $badge_selector, 'left', $render_slug );
			...
			et_pb_generate_responsive_css( $badge_top_position_values, $badge_selector, 'top', $render_slug );
		}
		...
		$global_badge_position = $badge_position !== 'top_right' ? " dsm_card_carousel_child_badge_{$badge_position}" : " dsm_card_carousel_child_badge_{$dsm_card_carousel_setting['badge_position']}";

		$image = $image ? sprintf(
			'<figure class="dsm_card_carousel_child_image_wrapper%2$s%5$s%7$s%8$s"%9$s%10$s>%1$s%6$s%4$s</figure>%3$s',
			$image_as_background !== 'on' ? $image : '<div class="dsm_card_carousel_child_image_background"></div>',
			esc_attr( $generate_css_image_filters ),
			( $badge_custom_position === 'on' ? $badge_text : '' ),
			( $badge_custom_position === 'off' ? $badge_text : '' ),
			$dsm_card_carousel_setting['badge_position'] !== 'top_right' ? $global_badge_position : " dsm_card_carousel_child_badge_{$badge_position}",
		...
		if ( $multi_view->has_value( 'title' ) || $multi_view->has_value( 'subtitle' ) || $multi_view->has_value( 'content' ) || $multi_view->has_value( 'button_text' ) ) {
			...
			$button = $this->render_button(
				array(
					'button_classname'    => array( 'et_pb_more_button', 'off' !== $button_image_popup ? 'dsm-card-image-lightbox dsm-card-lightbox-trigger' : '', 'off' !== $button_video_popup ? 'dsm-card-video-lightbox dsm-card-lightbox-trigger' : '' ),
		...
		if ( $badge_padding !== '7px|15px|7px|15px' ) {
		...
		$this->add_classname(
			array(
				$image_background_animation !== 'none' ? "dsm_card_carousel_child_image_animation dsm_card_carousel_child_image_animation_${image_background_animation}" : '',
				'swiper-slide',
