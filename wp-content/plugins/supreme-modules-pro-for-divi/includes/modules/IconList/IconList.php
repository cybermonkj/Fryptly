...
class DSM_Icon_List extends ET_Builder_Module {
	...
	public function init() {
		$this->name = esc_html__( 'Supreme Icon List', 'dsm-supreme-modules-pro-for-divi' );
		$this->icon = 'd';
		// Toggle settings
		$this->settings_modal_toggles = array(
			'general'  => array(
				'toggles' => array(
					'main_content' => esc_html__( 'Icon Lists', 'dsm-supreme-modules-pro-for-divi' ),
				),
			),
			'advanced' => array(
				'toggles' => array(
					'icon_settings'  => array(
						'title'    => esc_html__( 'Icon', 'dsm-supreme-modules-pro-for-divi' ),
						'priority' => 70,
					),
					...
					'list'           => array(
						'title'    => esc_html__( 'List Items', 'dsm-supreme-modules-pro-for-divi' ),
						'priority' => 70,
					),
				),
			),
		...
		return array(
			...
			'borders'      => array(
				...
				'list_item' => array(
					...
					'label_prefix' => esc_html__( 'List Item', 'dsm-supreme-modules-pro-for-divi' ),
					'tab_slug'     => 'advanced',
					'toggle_slug'  => 'list',
				),
			),
			'box_shadow'   => array(
				...
				'list_item' => array(
					'label'             => esc_html__( 'List Item Box Shadow', 'dsm-supreme-modules-pro-for-divi' ),
					'option_category'   => 'layout',
					'tab_slug'          => 'advanced',
					'toggle_slug'       => 'list',
					'css'               => array(
	...
	public function get_fields() {
		...
		return array(
			...
			'list_alignment'          => array(
				...
				'description'     => esc_html__( 'The List can be placed either above, below or in the center of the module.', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'select',
				'option_category' => 'layout',
				'options'         => array(
			...
			'list_background'         => array(
				...
				'type'           => 'color-alpha',
				'description'    => esc_html__( 'Here you can define a custom color for your list items.', 'dsm-supreme-modules-pro-for-divi' ),
				'tab_slug'       => 'advanced',
				'toggle_slug'    => 'list',
				'hover'          => 'tabs',
				'mobile_options' => true,
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		$text_selector = '%%order_class%% .dsm_icon_list_items .dsm_icon_list_child .dsm_icon_list_text';
		...
		if ( '26px' !== $image_max_width ) {
			...
			et_pb_generate_responsive_css( $image_max_width_values, '%%order_class%% .dsm_icon_list_items .dsm_icon_list_image img', 'width', $render_slug );
