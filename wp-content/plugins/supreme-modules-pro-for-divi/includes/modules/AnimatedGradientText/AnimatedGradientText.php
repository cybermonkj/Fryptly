...
class DSM_AnimatedGradientText extends ET_Builder_Module {
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		ET_Builder_Element::set_style($render_slug, array(
			...
			'declaration' => sprintf( 'background: linear-gradient(%1$s,%3$s,%4$s,%5$s,%6$s); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-size: 300%%; animation: dsm-animated-gradient-flow %2$s ease-in-out infinite; -webkit-animation: dsm-animated-gradient-flow %2$s ease-in-out infinite;',
		...
		if ( '' !== $animated_gradient_text ) {
			$animated_gradient_text = sprintf( '<%1$s class="dsm-animated-gradient-text et_pb_module_header">%2$s</%1$s>',
