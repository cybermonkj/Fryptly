...
class DSM_Perspective_Image extends ET_Builder_Module {
	...
	public function init() {
		$this->name = esc_html__( 'Supreme Image', 'dsm-supreme-modules-pro-for-divi' );
		$this->plural     = esc_html__( 'Supreme Images', 'dsm-supreme-modules-pro-for-divi' );
		$this->icon             = '&';
		...
		$this->settings_modal_toggles = array(
			'general'  => array(
				'toggles' => array(
					...
					'transform'    => esc_html__( 'Transform & Rotation', 'dsm-supreme-modules-pro-for-divi' ),
				),
			),
			'advanced' => array(
				'toggles' => array(
	...
	public function get_fields() {
		return array(
			...
			'dsm_rotate_y' => array(
				'label'           => esc_html__( 'Rotate Y', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'toggle_slug'     => 'transform',
				//'mobile_options'  => true,
			...
			'dsm_rotate_x' => array(
				'label'           => esc_html__( 'Rotate X', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'toggle_slug'     => 'transform',
				//'mobile_options'  => true,
			...
			'dsm_rotate_z' => array(
				'label'           => esc_html__( 'Rotate Z', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'toggle_slug'     => 'transform',
				//'mobile_options'  => true,
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		if ( 'on' === $show_in_lightbox ) {
			$output = sprintf( '<a href="%1$s" class="et_pb_lightbox_image dsm-image-lightbox" title="%3$s" data-mfp-src="%4$s" data-dsm-lightbox-id="%5$s">%2$s</a>',
				esc_attr( $src ),
				$output,
				esc_attr( $alt ),
			...
			$output = sprintf( '<a href="%1$s"%3$s class="%4$s" data-dsm-lightbox-id="%5$s">%2$s</a>',
				esc_url( $url ),
				$output,
		...
		if ( et_builder_is_hover_enabled( 'dsm_rotate_y', $this->props ) || et_builder_is_hover_enabled( 'dsm_rotate_x', $this->props ) || et_builder_is_hover_enabled( 'dsm_rotate_z', $this->props ) ) {
			$image_style_hover = sprintf( 'transform: perspective(%4$s)%1$s%2$s%3$s;',
