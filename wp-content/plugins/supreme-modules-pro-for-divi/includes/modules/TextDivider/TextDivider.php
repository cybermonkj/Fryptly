...
class DSM_Text_Divider extends ET_Builder_Module {
	...
	public function init() {
		$this->name             = esc_html__( 'Supreme Text Divider', 'dsm-supreme-modules-pro-for-divi' );
		$this->icon             = 'd';
	...
	public function get_advanced_fields_config() {
		return array(
			'fonts'          => array(
				'header' => array(
					'label'          => esc_html__( 'Divider', 'dsm-supreme-modules-pro-for-divi' ),
					'css'            => array(
	...
	public function get_fields() {
		return array(
			'header'           => array(
				'label'            => esc_html__( 'Divider Text', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'The text of divider will appear in between the divider.', 'dsm-supreme-modules-pro-for-divi' ),
			...
			'text_gap'         => array(
				'label'           => esc_html__( 'Text Gap', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'depends_show_if' => 'on',
				'tab_slug'        => 'advanced',
