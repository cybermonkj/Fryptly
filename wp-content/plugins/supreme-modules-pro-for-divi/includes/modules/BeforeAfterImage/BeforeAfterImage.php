...
class DSM_Before_After_Image extends ET_Builder_Module {
	...
	public function init() {
		$this->name             = esc_html__( 'Supreme Before/After Image Slider', 'dsm-supreme-modules-pro-for-divi' );
		$this->icon             = '&';
		...
		$this->settings_modal_toggles = array(
			'general'    => array(
				'toggles' => array(
					...
					'labels'          => esc_html__( 'Labels', 'dsm-supreme-modules-pro-for-divi' ),
					'slider_settings' => esc_html__( 'Settings', 'dsm-supreme-modules-pro-for-divi' ),
					'link'            => esc_html__( 'Link', 'dsm-supreme-modules-pro-for-divi' ),
				),
			),
			'advanced'   => array(
				'toggles' => array(
					'before_image'  => esc_html__( 'Before Image', 'dsm-supreme-modules-pro-for-divi' ),
					'before_label'  => esc_html__( 'Before Label', 'dsm-supreme-modules-pro-for-divi' ),
					'after_label'   => esc_html__( 'After Label', 'dsm-supreme-modules-pro-for-divi' ),
					'overlay'       => esc_html__( 'Overlay', 'dsm-supreme-modules-pro-for-divi' ),
					'handle_slider' => esc_html__( 'Handle Slider', 'dsm-supreme-modules-pro-for-divi' ),
					'width'         => array(
	...
	public function get_fields() {
		return array(
			'before_src'                    => array(
				...
				'upload_button_text' => esc_attr__( 'Upload an before image', 'dsm-supreme-modules-pro-for-divi' ),
				'choose_text'        => esc_attr__( 'Choose an before Image', 'dsm-supreme-modules-pro-for-divi' ),
				'update_text'        => esc_attr__( 'Set As Before Image', 'dsm-supreme-modules-pro-for-divi' ),
				'hide_metadata'      => true,
				'affects'            => array(
					'before_alt',
					'before_title_text',
				),
				'description'        => esc_html__( 'Upload your desired before image, or type in the URL to the image you would like to display.', 'dsm-supreme-modules-pro-for-divi' ),
				'toggle_slug'        => 'main_content',
			),
			'before_alt'                    => array(
				'label'           => esc_html__( 'Before Image Alternative Text', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'depends_show_if' => 'on',
				'depends_on'      => array(
			...
			'before_title_text'             => array(
				'label'           => esc_html__( 'Before Image Title Text', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'depends_show_if' => 'on',
				'depends_on'      => array(
			...
			'after_src'                     => array(
				'type'               => 'upload',
				'option_category'    => 'basic_option',
				'upload_button_text' => esc_attr__( 'Upload an after image', 'dsm-supreme-modules-pro-for-divi' ),
				'choose_text'        => esc_attr__( 'Choose an after Image', 'dsm-supreme-modules-pro-for-divi' ),
				'update_text'        => esc_attr__( 'Set As After Image', 'dsm-supreme-modules-pro-for-divi' ),
				'hide_metadata'      => true,
				'affects'            => array(
					'after_alt',
					'after_title_text',
				),
				'description'        => esc_html__( 'Upload your desired after image, or type in the URL to the image you would like to display.', 'dsm-supreme-modules-pro-for-divi' ),
				'toggle_slug'        => 'main_content',
			),
			'after_alt'                     => array(
				'label'           => esc_html__( 'After Image Alternative Text', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'depends_show_if' => 'on',
				'depends_on'      => array(
			...
			'after_title_text'              => array(
				'label'           => esc_html__( 'After Image Title Text', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'depends_show_if' => 'on',
				'depends_on'      => array(
			...
			'before_label_text'             => array(
				'label'           => esc_html__( 'Before Label Text', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'This defines the before label text.', 'dsm-supreme-modules-pro-for-divi' ),
				'toggle_slug'     => 'labels',
				'default'         => 'Before',
			),
			'after_label_text'              => array(
				'label'           => esc_html__( 'After Label Text', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'This defines the after label text.', 'dsm-supreme-modules-pro-for-divi' ),
				'toggle_slug'     => 'labels',
				'default'         => 'After',
			),
			'default_offset_pct'            => array(
				...
				'validate_unit'    => false,
				'unitless'         => true,
				'description'      => esc_html__( 'How much of the before image is visible when the page loads.', 'dsm-supreme-modules-pro-for-divi' ),
			...
			'no_overlay'                    => array(
				'label'            => esc_html__( 'No Overlay', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
				...
				'toggle_slug'      => 'slider_settings',
				'description'      => esc_html__( 'Here you can choose whether or not your to show overlay with before and after.', 'dsm-supreme-modules-pro-for-divi' ),
			),
			'move_slider_on_hover'          => array(
				'label'            => esc_html__( 'Move Slider on Hover?', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => esc_html__( 'No', 'dsm-supreme-modules-pro-for-divi' ),
				...
				'default_on_front' => 'off',
				'toggle_slug'      => 'slider_settings',
				'description'      => esc_html__( 'Move slider on mouse hover.', 'dsm-supreme-modules-pro-for-divi' ),
			),
			'move_with_handle_only'         => array(
				'label'            => esc_html__( 'Move Slider with Handle', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => esc_html__( 'No', 'dsm-supreme-modules-pro-for-divi' ),
				...
				'default_on_front' => 'on',
				'toggle_slug'      => 'slider_settings',
				'description'      => esc_html__( 'Allow a user to swipe anywhere on the image to control slider movement.', 'dsm-supreme-modules-pro-for-divi' ),
			),
			'click_to_move'                 => array(
				'label'            => esc_html__( 'Click to Move Slider', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => esc_html__( 'No', 'dsm-supreme-modules-pro-for-divi' ),
				...
				'default_on_front' => 'off',
				'toggle_slug'      => 'slider_settings',
				'description'      => esc_html__( 'Allow a user to click (or tap) anywhere on the image to move the slider to that location.', 'dsm-supreme-modules-pro-for-divi' ),
			),
			'before_label_background_color' => array(
				...
				'toggle_slug'      => 'before_label',
				'mobile_options'   => true,
				'description'      => esc_html__( 'Here you can define a custom background color for the before label.', 'dsm-supreme-modules-pro-for-divi' ),
			),
			'after_label_background_color'  => array(
				...
				'toggle_slug'      => 'after_label',
				'mobile_options'   => true,
				'description'      => esc_html__( 'Here you can define a custom background color for the after label.', 'dsm-supreme-modules-pro-for-divi' ),
			),
			'overlay_color'                 => array(
			...
			'handle_border_color'           => array(
				'label'            => esc_html__( 'Handle Border Color', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'color-alpha',
				'custom_color'     => true,
				...
				'mobile_options'   => true,
				'description'      => esc_html__( 'Here you can define a custom border color for the handle slider.', 'dsm-supreme-modules-pro-for-divi' ),
			),
			'handle_border_radius'          => array(
				'label'            => esc_html__( 'Handle Border Radius', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'range',
				'option_category'  => 'layout',
				'tab_slug'         => 'advanced',
				'toggle_slug'      => 'handle_slider',
			...
			'handle_background_color'       => array(
				'label'          => esc_html__( 'Handle Background Color', 'dsm-supreme-modules-pro-for-divi' ),
				'type'           => 'color-alpha',
				'custom_color'   => true,
				'tab_slug'       => 'advanced',
				'toggle_slug'    => 'handle_slider',
				'mobile_options' => true,
				'description'    => esc_html__( 'Here you can define a custom background color for the handle slider.', 'dsm-supreme-modules-pro-for-divi' ),
			),
			'handle_arrow_color'            => array(
				...
				'toggle_slug'      => 'handle_slider',
				'mobile_options'   => true,
				'description'      => esc_html__( 'Here you can define a custom arrow color for the handle slider.', 'dsm-supreme-modules-pro-for-divi' ),
			),
		);
	}
