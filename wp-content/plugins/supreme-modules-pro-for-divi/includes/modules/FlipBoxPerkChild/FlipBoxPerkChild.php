...
class DSM_FlipBox_Perk_Child extends ET_Builder_Module {
	...
	public function init() {
		$this->name                        = esc_html__( 'Flipbox Item', 'dsm-supreme-modules-pro-for-divi' );
		$this->advanced_setting_title_text = esc_html__( 'Flipbox Item', 'dsm-supreme-modules-pro-for-divi' );
		$this->settings_text               = esc_html__( 'Flipbox Item Settings', 'dsm-supreme-modules-pro-for-divi' );
