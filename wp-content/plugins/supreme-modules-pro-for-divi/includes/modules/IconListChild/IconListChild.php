...
class DSM_Icon_List_Child extends ET_Builder_Module {
	...
	public function init() {
		$this->name                        = esc_html__( 'Icon List Item', 'dsm-supreme-modules-pro-for-divi' );
		$this->child_title_var             = 'text';
		$this->advanced_setting_title_text = esc_html__( 'Icon List Item', 'dsm-supreme-modules-pro-for-divi' );
		$this->settings_text               = esc_html__( 'Icon List Settings', 'dsm-supreme-modules-pro-for-divi' );

		$this->settings_modal_toggles = array(
			'general'    => array(
				'toggles' => array(
					'main_content' => esc_html__( 'Content', 'dsm-supreme-modules-pro-for-divi' ),
					'tooltip'      => esc_html__( 'Tooltip', 'dsm-supreme-modules-pro-for-divi' ),
			...
			'advanced'   => array(
				'toggles' => array(
					...
					'tooltip_settings' => esc_html__( 'Tooltip', 'dsm-supreme-modules-pro-for-divi' ),
					'text'             => array(
		...
		return array(
			'fonts'           => array(
				'text'    => array(
					...
					'css'               => array(
						'main'      => '.dsm_icon_list %%order_class%%.dsm_icon_list_child, .dsm_icon_list %%order_class%%.dsm_icon_list_child a',
						'important' => 'all',
					),
					'font_size'         => array(
						'default' => '14px',
				...
				'tooltip' => array(
					'label'          => esc_html__( 'Tooltip', 'dsm-supreme-modules-pro-for-divi' ),
					'css'            => array(
			...
			'text'            => array(
				...
				'css'                   => array(
					'text_shadow' => '.dsm_icon_list %%order_class%%.dsm_icon_list_child .dsm_icon_list_child',
				),
			),
			'borders'         => array(
				'default' => array(),
				'icon'    => array(
					'css'          => array(
						'main' => array(
							'border_radii'  => '.dsm_icon_list %%order_class%%.dsm_icon_list_child .dsm_icon_list_icon',
							'border_styles' => '.dsm_icon_list %%order_class%%.dsm_icon_list_child .dsm_icon_list_icon',
						),
					),
				...
				'image'   => array(
					'css'          => array(
						'main' => array(
							'border_radii'  => '.dsm_icon_list %%order_class%%.dsm_icon_list_child .dsm_icon_list_image',
							'border_styles' => '.dsm_icon_list %%order_class%%.dsm_icon_list_child .dsm_icon_list_image',
						),
					),
			...
			'box_shadow'      => array(
				'default' => array(),
				'icon'    => array(
					'label'             => esc_html__( 'Icon Box Shadow', 'dsm-supreme-modules-pro-for-divi' ),
					'option_category'   => 'layout',
					'tab_slug'          => 'advanced',
					'toggle_slug'       => 'icon_settings',

					'css'               => array(
						'main' => '.dsm_icon_list %%order_class%%.dsm_icon_list_child .dsm_icon_list_icon',
					),
				...
				'image'   => array(
					...
					'css'               => array(
						'main' => '.dsm_icon_list %%order_class%%.dsm_icon_list_child .dsm_icon_list_image',
					),
					'default_on_fronts' => array(
						'color'    => '',
						'position' => '',
	...
	public function get_fields() {
		...
		return array(
			...
			'font_icon'                => array(
				...
				'toggle_slug'      => 'main_content',
				'description'      => esc_html__( 'Choose an icon to display with your text.', 'dsm-supreme-modules-pro-for-divi' ),
				'depends_show_if'  => 'on',
				// 'mobile_options'      => true,
				'hover'            => 'tabs',
				'default'          => 'P',
			...
			'icon_background_color'    => array(
				'label'           => esc_html__( 'Icon Background Color', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'color-alpha',
			...
			'icon_padding'             => array(
				'label'           => esc_html__( 'Icon Padding', 'dsm-supreme-modules-pro-for-divi' ),
				'description'     => esc_html__( 'Here you can define a custom padding size for the icon.', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'range',
			...
			'image'                    => array(
				...
				'depends_show_if'    => 'off',
				'description'        => esc_html__( 'Upload an image to display with your text', 'dsm-supreme-modules-pro-for-divi' ),
				'toggle_slug'        => 'main_content',
				'mobile_options'     => true,
				'hover'              => 'tabs',
			),
			...
			'image_background_color'   => array(
				'label'           => esc_html__( 'Image Background Color', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'color-alpha',
				'description'     => esc_html__( 'Here you can define a custom background color for your image.', 'dsm-supreme-modules-pro-for-divi' ),
				'tab_slug'        => 'advanced',
				'toggle_slug'     => 'image_settings',
				'hover'           => 'tabs',
				'mobile_options'  => true,
			...
			'image_padding'            => array(
				'label'           => esc_html__( 'Image Padding', 'dsm-supreme-modules-pro-for-divi' ),
				'description'     => esc_html__( 'Here you can define a custom padding size for the image.', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'range',
				'option_category' => 'font_option',
				'tab_slug'        => 'advanced',
				'toggle_slug'     => 'image_settings',
			...
			'content'                  => array(
				...
				'type'            => 'tiny_mce',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Tooltip Content entered here will show up.', 'dsm-supreme-modules-pro-for-divi' ),
				'toggle_slug'     => 'tooltip',
				'show_if'         => array(
					'use_tooltip' => 'on',
				),
			...
			'url'                      => array(
				...
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'If you would like to make your Icon List a link, input your destination URL here.', 'dsm-supreme-modules-pro-for-divi' ),
				'toggle_slug'     => 'link_options',
			),
			'url_new_window'           => array(
				'label'            => esc_html__( 'Title Link Target', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'select',
			...
			'text_indent'              => array(
				'label'            => esc_html__( 'Text Indent', 'dsm-supreme-modules-pro-for-divi' ),
				'description'      => esc_html__( 'Here you can add padding between the icons and the text.', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'range',
				'option_category'  => 'font_option',
				'tab_slug'         => 'advanced',
				'toggle_slug'      => 'text',
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		if ( 'off' === $use_icon ) {
			...
			if ( '' !== $image_padding ) {
				...
				et_pb_generate_responsive_css( $image_padding_values, $image_selector, 'padding', $render_slug );
		...
		if ( 'on' === $use_tooltip ) {
			$content = sprintf(
				...
				substr( strstr( $this->module_classname( $render_slug ), ' ' ), 21 )
			);
