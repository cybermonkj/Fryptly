...
class DSM_Image_Hotspots_Child extends ET_Builder_Module {
		...
		return array(
			'fonts'            => array(
				'text'     => array(
					...
					'css'               => array(
						'main' => '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .dsm_image_hotspots_wrapper .dsm_image_hotspots_text',
					),
					'font_size'         => array(
						'default' => '14px',
					),
				...
				'header_2' => array(
					...
					'css'         => array(
						'main' => ".dsm_image_hotspots {$this->main_css_element}.dsm_image_hotspot_tooltip_wrapper.tippy-tooltip h2",
					),
					'font_size'   => array(
						'default' => '26px',
					),
				...
				'header_3' => array(
					...
					'css'         => array(
						'main' => ".dsm_image_hotspots {$this->main_css_element}.dsm_image_hotspot_tooltip_wrapper.tippy-tooltip h3",
					),
					'font_size'   => array(
						'default' => '22px',
					),
				...
				'header_4' => array(
					...
					'css'         => array(
						'main' => ".dsm_image_hotspots {$this->main_css_element}.dsm_image_hotspot_tooltip_wrapper.tippy-tooltip h4",
					),
					'font_size'   => array(
						'default' => '18px',
					),
				...
				'header_5' => array(
					...
					'css'         => array(
						'main' => ".dsm_image_hotspots {$this->main_css_element}.dsm_image_hotspot_tooltip_wrapper.tippy-tooltip h5",
					),
					'font_size'   => array(
						'default' => '16px',
					),
				...
				'header_6' => array(
					...
					'css'         => array(
						'main' => ".dsm_image_hotspots {$this->main_css_element}.dsm_image_hotspot_tooltip_wrapper.tippy-tooltip h6",
					),
					'font_size'   => array(
						'default' => '14px',
					),
				...
				'body'     => array(
					...
					'css'            => array(
						'main'        => ".dsm_image_hotspots {$this->main_css_element}.dsm_image_hotspot_tooltip_wrapper.tippy-tooltip .dsm_image_tooltip_content",
						'line_height' => ".dsm_image_hotspots {$this->main_css_element}.dsm_image_hotspot_tooltip_wrapper.tippy-tooltip p",
						'text_align'  => ".dsm_image_hotspots {$this->main_css_element}.dsm_image_hotspot_tooltip_wrapper.tippy-tooltip",
						'text_shadow' => ".dsm_image_hotspots {$this->main_css_element}.dsm_image_hotspot_tooltip_wrapper.tippy-tooltip",
					),
					'block_elements' => array(
						'tabbed_subtoggles' => true,
						'bb_icons_support'  => true,
						'css'               => array(
							'main' => ".dsm_image_hotspots {$this->main_css_element}.dsm_image_hotspot_tooltip_wrapper.tippy-tooltip",
						),
					),
				),
			),
			'background'       => array(
				'css'     => array(
					'main' => '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .dsm_image_hotspots_wrapper',
				),
				'options' => array(
			...
			'borders'          => array(
				...
				'hotspot' => array(
					'css'          => array(
						'main' => array(
							'border_radii'  => '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .dsm_image_hotspots_wrapper',
							'border_styles' => '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .dsm_image_hotspots_wrapper',
						),
					),
					'defaults'     => array(
				...
				'image'   => array(
					'css'          => array(
						'main' => array(
							'border_radii'  => '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .dsm_image_hotspot_img',
							'border_styles' => '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .dsm_image_hotspot_img',
						),
					),
				...
				'pulse'   => array(
					'css'             => array(
						'main' => array(
							'border_radii'  => '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .dsm_image_hotspot_pulse:before',
							'border_styles' => '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .dsm_image_hotspot_pulse:before',
						),
					),
					'defaults'        => array(
						'border_radii' => 'on|50px|50px|50px|50px',
			...
			'box_shadow'       => array(
				...
				'image'   => array(
					...
					'toggle_slug'       => 'hotspot_image_settings',
					'css'               => array(
						'main' => '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .dsm_image_hotspot_img',
					),
			...
			'margin_padding'   => array(
				'css' => array(
					'main'      => '.dsm_image_hotspots %%order_class%%',
					'important' => 'all',
				),
			),
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		$hotspot_selector                  = '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child';
		$hotspot_wrapper_selector          = '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .dsm_image_hotspots_wrapper';
		$icon_selector                     = '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .dsm_image_hotspots_icon';
		$pulse_selector                    = '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .dsm_image_hotspot_pulse:before';
		$tooltip_background_color_selector = '%%order_class%%.dsm_image_hotspot_tooltip_wrapper.tippy-tooltip';
		$tooltip_selector                  = '%%order_class%%.dsm_image_hotspot_tooltip_wrapper.tippy-tooltip .tippy-content';
		$tooltip_padding_selector          = '%%order_class%%.dsm_image_hotspot_tooltip_wrapper.tippy-tooltip .tippy-content';
		...
		et_pb_generate_responsive_css( $left_position_values, $hotspot_selector, 'left', $render_slug );
		...
		et_pb_generate_responsive_css( $top_position_values, $hotspot_selector, 'top', $render_slug );
		...
		if ( 'image' === $hotspot_type ) {
			...
			if ( $this->props['box_shadow_style_image'] !== 'none' ) {
				ET_Builder_Element::set_style(
					$render_slug,
					array(
		...
		$output = sprintf(
			'%5$s<div class="dsm_image_hotspots_wrapper" data-tippy-arrow="true" data-tippy-placement="%3$s" data-slug="%4$s"%6$s%7$s>%1$s</div>%2$s',
			$hotspot_type_output,
			$tooltip_wrapper,
			esc_attr( $tooltip_placement ),
			substr( strstr( $this->module_classname( $render_slug ), ' ' ), 1 ),
