	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		if ( '' !== $typing_effect ) {
			$typing_effect = sprintf(
				'<%1$s class="dsm-typing-effect et_pb_module_header">%7$s<span class="dsm-typing-wrapper"><span class="dsm-typing-strings">%9$s</span><span class="dsm-typing" data-dsm-typing-strings="%2$s"%3$s%4$s%5$s%6$s></span></span>%8$s</%1$s>',
