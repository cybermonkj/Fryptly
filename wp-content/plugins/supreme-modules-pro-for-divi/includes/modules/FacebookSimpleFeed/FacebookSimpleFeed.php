...
class DSM_FacebookSimpleFeed extends ET_Builder_Module {
	...
	public function init() {
		$this->name = esc_html__( 'Supreme Facebook Feed', 'dsm-supreme-modules-pro-for-divi' );
		$this->icon             = '';
		// Toggle settings
		$this->settings_modal_toggles  = array(
			'general'  => array(
				'toggles' => array(
					'main_content' => esc_html__( 'Facebook Feed Settings', 'dsm-supreme-modules-pro-for-divi' ),
				),
			),
			'advanced' => array(
				'toggles' => array(
	...
	public function get_fields() {
		return array(
			...
			'fb_page_url' => array(
				'label'           => esc_html__( 'Facebook Page URL', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Enter the Facebook Page URL.', 'dsm-supreme-modules-pro-for-divi' ),
				'toggle_slug'     => 'main_content',
				'default_on_front' => 'https://www.facebook.com/divisupreme/',
			),
			'fb_tabs' => array(
				'label'           => esc_html__( 'Tabs', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'multiple_checkboxes',
				'option_category' => 'configuration',
				'options'         => array(
					'timeline' => esc_html__( 'Timeline', 'dsm-supreme-modules-pro-for-divi' ),
					'events' => esc_html__( 'Events', 'dsm-supreme-modules-pro-for-divi' ),
					'messages'  => esc_html__( 'Messages', 'dsm-supreme-modules-pro-for-divi' ),
				),
				'default' => 'on|off|off',
				'toggle_slug'      => 'main_content',
				'description'      => esc_html__( 'Here you can choose to show tabs on your facebook page.', 'dsm-supreme-modules-pro-for-divi' ),

			),
			'fb_hide_cover' => array(
				'label'            => esc_html__( 'Hide Cover Photo', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
					'false' => esc_html__( 'Show', 'dsm-supreme-modules-pro-for-divi' ),
					'true'  => esc_html__( 'Hide', 'dsm-supreme-modules-pro-for-divi' ),
				),
				'toggle_slug'      => 'main_content',
				'description'      => esc_html__( 'Hide cover photo in the header.', 'dsm-supreme-modules-pro-for-divi' ),
				'default_on_front' => 'false',
			),
			'fb_small_header' => array(
				'label'            => esc_html__( 'Use Small Header?', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
			...
			'fb_show_facepile' => array(
				'label'            => esc_html__( 'Show Face Pile', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
				...
				'toggle_slug'      => 'main_content',
				'description'      => esc_html__( 'Show profile photos when friends like this.', 'dsm-supreme-modules-pro-for-divi' ),
			...
			'fb_alignment' => array(
				...
				'description'      => esc_html__( 'Here you can define the alignment of Facebook Feed', 'dsm-supreme-modules-pro-for-divi' ),
				'default' => 'center',
			),
		);
	}
