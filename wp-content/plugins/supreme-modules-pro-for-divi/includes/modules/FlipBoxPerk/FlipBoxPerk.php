...
class DSM_FlipBox_Perk extends ET_Builder_Module {
	...
	public function init() {
		$this->name = esc_html__( 'Supreme Flipbox', 'dsm-supreme-modules-pro-for-divi' );
		$this->icon = 'j';
		// Toggle settings
	...
	public function get_fields() {
		return array(
			'flipbox_type'            => array(
				'label'           => esc_html__( 'Flipbox Type', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'default'         => 'flip',
				'options'         => array(
					'flip'     => esc_html__( 'Flip', 'dsm-supreme-modules-pro-for-divi' ),
					'slide'    => esc_html__( 'Slide', 'dsm-supreme-modules-pro-for-divi' ),
					'zoom-in'  => esc_html__( 'Zoom In', 'dsm-supreme-modules-pro-for-divi' ),
					'zoom-out' => esc_html__( 'Zoom Out', 'dsm-supreme-modules-pro-for-divi' ),
			...
			'flipbox_effect'          => array(
				'label'           => esc_html__( 'Flipbox Effect', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'default'         => 'right',
				'options'         => array(
					'left'  => esc_html__( 'Flip Left', 'dsm-supreme-modules-pro-for-divi' ),
					'right' => esc_html__( 'Flip Right', 'dsm-supreme-modules-pro-for-divi' ),
					'up'    => esc_html__( 'Flip Up', 'dsm-supreme-modules-pro-for-divi' ),
					'down'  => esc_html__( 'Flip Down', 'dsm-supreme-modules-pro-for-divi' ),
				),
				'tab_slug'        => 'advanced',
				'toggle_slug'     => 'animation',
				'show_if'         => array(
			...
			'flipbox_3d'              => array(
				'label'           => esc_html__( '3D Effect', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'yes_no_button',
			...
			'flipbox_slide_effect'    => array(
				'label'           => esc_html__( 'Flipbox Slide Effect', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'default'         => 'slide-up',
				'options'         => array(
					'slide-up'    => esc_html__( 'Slide Up', 'dsm-supreme-modules-pro-for-divi' ),
					'slide-down'  => esc_html__( 'Slide Down', 'dsm-supreme-modules-pro-for-divi' ),
					'slide-left'  => esc_html__( 'Slide Left', 'dsm-supreme-modules-pro-for-divi' ),
					'slide-right' => esc_html__( 'Slide Right', 'dsm-supreme-modules-pro-for-divi' ),
				),
				'tab_slug'        => 'advanced',
				'toggle_slug'     => 'animation',
				'show_if'         => array(
			...
			'flipbox_zoom_out_effect' => array(
				'label'           => esc_html__( 'Flipbox Zoom Out Effect', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'default'         => 'zoom-out',
				'options'         => array(
					'zoom-out'       => esc_html__( 'Zoom Out', 'dsm-supreme-modules-pro-for-divi' ),
					'zoom-out-up'    => esc_html__( 'Zoom Out Up', 'dsm-supreme-modules-pro-for-divi' ),
					'zoom-out-down'  => esc_html__( 'Zoom Out Down', 'dsm-supreme-modules-pro-for-divi' ),
					'zoom-out-left'  => esc_html__( 'Zoom Out Left', 'dsm-supreme-modules-pro-for-divi' ),
					'zoom-out-right' => esc_html__( 'Zoom Out Right', 'dsm-supreme-modules-pro-for-divi' ),
				),
				'tab_slug'        => 'advanced',
				'toggle_slug'     => 'animation',
				'show_if'         => array(
			...
			'flipbox_speed'           => array(
				'label'            => esc_html__( 'Animation Speed (in s)', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'range',
				'option_category'  => 'configuration',
				'default'          => '0.6s',
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		$output = sprintf(
			'<div class="dsm-flipbox%2$s%3$s%4$s%5$s%6$s%7$s">%1$s</div>',
