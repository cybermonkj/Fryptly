...
class DSM_PriceList_Child extends ET_Builder_Module {
	...
	public function init() {
		$this->name = esc_html__( 'Price List Item', 'dsm-supreme-modules-pro-for-divi' );
		$this->advanced_setting_title_text = esc_html__( 'Price List Item', 'dsm-supreme-modules-pro-for-divi' );
		$this->settings_text = esc_html__( 'Price List Item Settings', 'dsm-supreme-modules-pro-for-divi' );
	...
	public function get_fields() {
		...
		return array(
			'price' => array(
				...
				'description'     => esc_html__( 'Add the price of the item', 'dsm-supreme-modules-pro-for-divi' ),
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		if ( '' !== $image_max_width_tablet || '' !== $image_max_width_phone || '' !== $image_max_width ) {
			...
			et_pb_generate_responsive_css( $image_max_width_values, '%%order_class%%.dsm_pricelist_child .dsm-pricelist-image', 'max-width', $render_slug );
		}
		...
		if ( '' !== $image_spacing_tablet || '' !== $image_spacing_phone || '' !== $image_spacing ) {
			...
			et_pb_generate_responsive_css( $image_spacing_values, '%%order_class%%.dsm_pricelist_child .dsm-pricelist-image', 'margin-right', $render_slug );				
		}
