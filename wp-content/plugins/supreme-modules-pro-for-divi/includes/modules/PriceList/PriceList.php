...
class DSM_PriceList extends ET_Builder_Module {
	...
	public function init() {
		$this->name = esc_html__( 'Supreme Price List', 'dsm-supreme-modules-pro-for-divi' );
		$this->icon             = '(';
		// Toggle settings
	...
	public function get_advanced_fields_config() {
		return array(
			'fonts'      => array(
				...
				'price' => array(
					'label'    => esc_html__( 'Price', 'dsm-supreme-modules-pro-for-divi' ),
					'css'      => array(
			...
			'borders'               => array(
				...
				'image_price'   => array(
					...
					'label_prefix'    => esc_html__( 'Price', 'dsm-supreme-modules-pro-for-divi' ),
					'tab_slug'          => 'advanced',
					'toggle_slug'       => 'price',
				),
			),
			'box_shadow'            => array(
				...
				'image_price'   => array(
					'label'               => esc_html__( 'Price Box Shadow', 'dsm-supreme-modules-pro-for-divi' ),
					'option_category'     => 'layout',
					'tab_slug'          => 'advanced',
					'toggle_slug'       => 'price',
					'css'                 => array(
	...
	public function get_fields() {
		return array(
			...
			'item_bottom_gap' => array(
				'label'             => esc_html__( 'Item Bottom Spacing', 'dsm-supreme-modules-pro-for-divi' ),
				'type'              => 'range',
			...
			'price_background_color' => array(
				'label'             => esc_html__( 'Price Background Color', 'dsm-supreme-modules-pro-for-divi' ),
				'type'              => 'color-alpha',
				'description'       => esc_html__( 'Here you can define a custom background color for your price.', 'dsm-supreme-modules-pro-for-divi' ),
				'tab_slug'          => 'advanced',
				'toggle_slug'       => 'price',
				'mobile_options'  => true,
				'responsive'      => true,
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		if ( '' !== $separator_gap_tablet || '' !== $separator_gap_phone || '' !== $separator_gap ) {
			...
			et_pb_generate_responsive_css( $separator_gap_values, '%%order_class%% .dsm-pricelist-separator', 'margin-left', $render_slug );
            et_pb_generate_responsive_css( $separator_gap_values, '%%order_class%% .dsm-pricelist-separator', 'margin-right', $render_slug );
		}
