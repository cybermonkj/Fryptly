...
class DSM_Button extends ET_Builder_Module {
	...
	public function get_fields() {
		...
		return array(
			'button_one_text'                    => array(
				'label'           => sprintf( esc_html__( 'Button %1$s Text', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'            => 'text',
			...
			'button_one_url_type'                => array(
				'label'            => sprintf( esc_html__( 'Link Type for Button %1$s', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'             => 'select',
			...
			'button_one_email_address'           => array(
				'label'            => sprintf( esc_html__( 'Email', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
			...
			'button_one_email_cc'                => array(
				'label'            => sprintf( esc_html__( 'CC', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
			...
			'button_one_email_bcc'               => array(
				'label'            => sprintf( esc_html__( 'BCC', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
			...
			'button_one_email_subject'           => array(
				'label'           => sprintf( esc_html__( 'Subject', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
			...
			'button_one_email_msg'               => array(
				'label'            => sprintf( esc_html__( 'Message', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'             => 'textarea',
				'option_category'  => 'basic_option',
			...
			'button_one_phone_number'            => array(
				'label'            => sprintf( esc_html__( 'Phone Number', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
			...
			'button_one_sms_body_text'           => array(
				'label'            => sprintf( esc_html__( 'Body Text', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'             => 'textarea',
				'option_category'  => 'basic_option',
			...
			'button_one_fb_messenger'            => array(
				'label'            => sprintf( esc_html__( 'Username', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
			...
			'button_one_whatsapp_number'         => array(
				'label'            => sprintf( esc_html__( 'Number', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
			...
			'button_one_telegram'                => array(
				'label'            => sprintf( esc_html__( 'Telegram Username', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
			...
			'button_one_url'                     => array(
				'label'           => sprintf( esc_html__( 'Button %1$s URL', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
			...
			'button_two_text'                    => array(
				'label'           => sprintf( esc_html__( 'Button %1$s Text', 'dsm-supreme-modules-pro-for-divi' ), '#2' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Enter the text for the Button.', 'dsm-supreme-modules-pro-for-divi' ),
				'toggle_slug'     => 'main_content',
			...
			'button_two_url_type'                => array(
				'label'            => sprintf( esc_html__( 'Link Type for Button %1$s', 'dsm-supreme-modules-pro-for-divi' ), '#2' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
					'url'          => esc_html__( 'URL Link', 'dsm-supreme-modules-pro-for-divi' ),
			...
			'button_two_url'                     => array(
				'label'           => sprintf( esc_html__( 'Button %1$s URL', 'dsm-supreme-modules-pro-for-divi' ), '#2' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Enter the URL for the Button.', 'dsm-supreme-modules-pro-for-divi' ),
				'toggle_slug'     => 'links',
			...
			'button_one_hover_animation'         => array(
				'label'            => sprintf( esc_html__( 'Button Hover %1$s Animation', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
					...
					'dsm-pulse-shrink'           => esc_html__( 'Pulse Grow', 'dsm-supreme-modules-pro-for-divi' ),
			...
			'button_one_icon_hover_animation'    => array(
				'label'            => sprintf( esc_html__( 'Button Icon Hover %1$s Animation', 'dsm-supreme-modules-pro-for-divi' ), '#1' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
			...
			'button_two_hover_animation'         => array(
				'label'            => sprintf( esc_html__( 'Button Hover %1$s Animation', 'dsm-supreme-modules-pro-for-divi' ), '#2' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
					'dsm-none'                   => esc_html__( 'None', 'dsm-supreme-modules-pro-for-divi' ),
			...
			'button_two_icon_hover_animation'    => array(
				'label'            => sprintf( esc_html__( 'Button Icon Hover %1$s Animation', 'dsm-supreme-modules-pro-for-divi' ), '#2' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
					'dsm-icon-none'         => esc_html__( 'None', 'dsm-supreme-modules-pro-for-divi' ),
	...
	function render( $attrs, $content = null, $render_slug ) {
		...
		if ( '' !== $button_one_text ) {
			...
			$button_output .= sprintf(
				'<a class="et_pb_button et_pb_button_one%5$s%8$s%9$s%10$s%12$s %7$s" %6$s href="%1$s"%3$s%4$s data-dsm-lightbox-id="dsm_button_one_lightbox %11$s "%13$s>%2$s</a>',
				$link_one_url,
		...
		if ( '' !== $button_two_text ) {
			...
			$button_output .= sprintf(
				'<a class="et_pb_button et_pb_button_two%5$s%8$s%9$s%10$s%12$s %7$s" %6$s href="%1$s"%3$s%4$s data-dsm-lightbox-id="dsm_button_two_lightbox %11$s"%13$s>%2$s</a>',
				$link_two_url,
		...
		$output = sprintf(
			'<div class="et_pb_button_module_wrapper dsm_button_%3$s_wrapper %2$s et_pb_module%4$s%5$s%8$s"%6$s%7$s>
				%1$s
			</div>',
			$button_output,
