...
class DSM_Text_Badges extends ET_Builder_Module {
	...
	public function init() {
		$this->name = esc_html__( 'Supreme Text Badges', 'dsm-supreme-modules-pro-for-divi' );
		$this->icon = '';
		// Toggle settings
	...
	public function get_advanced_fields_config() {
		return array(
			'fonts'          => array(
				...
				'badges' => array(
					'label'            => esc_html__( 'Badges', 'dsm-supreme-modules-pro-for-divi' ),
					'css'              => array(
	...
	public function get_fields() {
		...
		return array(
			'main_text'               => array(
				'label'            => esc_html__( 'Main Text', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'text',
			...
			'badges_text'             => array(
				'label'            => esc_html__( 'Badges Text', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'toggle_slug'      => 'main_content',
			...
			'badges_placement'        => array(
				'label'           => esc_html__( 'Badges Placement', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'before' => esc_html__( 'Before', 'dsm-supreme-modules-pro-for-divi' ),
					'after'  => esc_html__( 'After', 'dsm-supreme-modules-pro-for-divi' ),
				),
				'default'         => 'after',
				'description'     => esc_html__( 'Here you can choose the placement of the badges to be before or after the Main Text.', 'dsm-supreme-modules-pro-for-divi' ),
				'toggle_slug'     => 'main_content',
			),
			'badges_background_color' => array(
				...
				'tab_slug'     => 'advanced',
				'toggle_slug'  => 'badges',
				'description'  => esc_html__( 'Here you can define a custom background color for the badge', 'dsm-supreme-modules-pro-for-divi' ),
			),
			'badges_gap'              => array(
				...
				'allow_empty'      => true,
				'responsive'       => true,
				'description'      => esc_html__( 'Here you can define a gap between the text and the badge', 'dsm-supreme-modules-pro-for-divi' ),
			),
		);
	}
