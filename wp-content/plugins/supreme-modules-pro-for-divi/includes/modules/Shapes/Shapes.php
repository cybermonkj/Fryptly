...
class DSM_Shapes extends ET_Builder_Module {
	...
	public function init() {
		$this->name             = esc_html__( 'Supreme Shapes', 'dsm-supreme-modules-pro-for-divi' );
		$this->icon             = '';
		...
		$this->settings_modal_toggles = array(
			'general'    => array(
				'toggles' => array(
					'main_content' => esc_html__( 'Shapes', 'dsm-supreme-modules-pro-for-divi' ),
			...
			'advanced'   => array(
				'toggles' => array(
					'shapes_settings' => esc_html__( 'Shapes', 'dsm-supreme-modules-pro-for-divi' ),
					'text'            => array(
		...
		return array(
			...
			'borders'        => array(
				...
				'shapes'  => array(
					...
					'label_prefix'    => esc_html__( 'Shapes', 'dsm-supreme-modules-pro-for-divi' ),
					'tab_slug'        => 'advanced',
			...
			'box_shadow'     => array(
				...
				'shapes'  => array(
					'label'             => esc_html__( 'Shapes Shadow', 'dsm-supreme-modules-pro-for-divi' ),
		...
		return array(
			'shapes_type'        => array(
				...
				'options'          => array(
					...
					'rectangle'      => esc_html__( 'Rectangle', 'dsm-supreme-modules-pro-for-divi' ),
					'triangle'       => esc_html__( 'Triangle', 'dsm-supreme-modules-pro-for-divi' ),
					'oval'           => esc_html__( 'Oval', 'dsm-supreme-modules-pro-for-divi' ),
					'trapezoid'      => esc_html__( 'Trapezoid', 'dsm-supreme-modules-pro-for-divi' ),
					'parallelogram'  => esc_html__( 'Parallelogram', 'dsm-supreme-modules-pro-for-divi' ),
					'diamond_square' => esc_html__( 'Diamond Square', 'dsm-supreme-modules-pro-for-divi' ),
					'hexagon'        => esc_html__( 'Hexagon', 'dsm-supreme-modules-pro-for-divi' ),
					'blob_one'       => esc_html__( 'Blob #1', 'dsm-supreme-modules-pro-for-divi' ),
					'blob_two'       => esc_html__( 'Blob #2', 'dsm-supreme-modules-pro-for-divi' ),
					'blob_three'     => esc_html__( 'Blob #3', 'dsm-supreme-modules-pro-for-divi' ),
					'blob_four'      => esc_html__( 'Blob #4', 'dsm-supreme-modules-pro-for-divi' ),
					'blob_five'      => esc_html__( 'Blob #5', 'dsm-supreme-modules-pro-for-divi' ),
					'blob_six'       => esc_html__( 'Blob #6', 'dsm-supreme-modules-pro-for-divi' ),
					'blob_seven'     => esc_html__( 'Blob #7', 'dsm-supreme-modules-pro-for-divi' ),
					'blob_eight'     => esc_html__( 'Blob #8', 'dsm-supreme-modules-pro-for-divi' ),
				),
			...
			'shapes_square_size' => array(
				...
				'description'      => esc_html__( 'Adjust size of the Shape.', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'range',
				'option_category'  => 'layout',
				'toggle_slug'      => 'main_content',
				'mobile_options'   => true,
			...
			'shape_color'        => array(
				'label'            => esc_html__( 'Shape Color', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'color-alpha',
				'custom_color'     => true,
				...
				'tab_slug'         => 'advanced',
				'toggle_slug'      => 'shapes_settings',
				'description'      => esc_html__( 'Here you can define a custom color for the shapes', 'dsm-supreme-modules-pro-for-divi' ),
			),
			'use_shape_border'   => array(
				'label'            => esc_html__( 'Use Border', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'yes_no_button',
