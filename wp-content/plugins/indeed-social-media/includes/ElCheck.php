...
class ElCheck
{
     ...
     * @var string
     */
    private $pluginId             = '8137709';
    /**
     * @var string
     */
    private $ajax                 = 'ism_el_check_get_url_ajax';//
    /**
     * @var string
     */
    private $wpIndeedUrlEndpoint  = 'https://wpindeed.com/wp-content/plugins/wpindeed-envato/input.php';
    /**
     * @var string
     */
    private $optionName           = 'ism_license_set';
    /**
     * @var string
     */
    private $hashOptionName       = 'ism_license_hash';
    /**
     * @var string
     */
    private $purchaseOptionName   = 'ism_envato_code';
    /**
     * @var string
     */
     ...
     * @var string
     */
    private $ajaxRevoke           = 'ism_revoke_license';//
    /**
     * @var string
     */
     ...
     * @var string
     */
    private $licenseTokenOptionName  = 'ism_license_token';
    /**
     * @var string
     */
    private $redirectBackPath        = 'admin.php?page=ism_manage&tab=help';
    /**
     * @var string
     */
    private $gateResponse            = 'ism_elc_response';
    /**
     * @var string
     */
    private $nonceName               = 'ism_license_nonce';
    /**
     * @var string
     */
    private $pluginBaseFile          = ISM_DIR_PATH . 'indeed-social-pro.php';
    ...
    public function responseCodeToMessage( $code=0, $errorClass='', $successClass='', $langCode )
    {
        if ( isset( $_GET['response_message'] ) ){
            ...
            return "<div class='$class'>" . urldecode( $_GET['response_message'] ) . "</div>";
        }
        switch ( $code ){
            case 1:
