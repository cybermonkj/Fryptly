...
$newsletter_table_name = $wpdb->prefix . "ism_newsletter_subscribe";
$sql = "DROP TABLE IF EXISTS $newsletter_table_name;";
$wpdb->query($sql);
...
$arr3 = array('ism_sm_internal_counts_share', 'ism_special_count_all', 'ism_min_count', 'ism_go_custom_share_c','ism_license_set','ism_envato_code');
foreach($arr2 as $v){
