	...
	<div class="stuffbox-ism">
        ...
        <div class="stuffbox-ism">
            ...
            <div class="inside">
                        ...
                        <tr valign="top">
                            <td><label><h4 style="margin:0px; display:inline-block;">FaceBook App ID:</h4></label>
                                <input type="text" value="<?php echo $meta_arr['facebook_id'];?>" name="facebook_id" id="facebook_id"/>
												...
												<tr valign="top">
												<!--developer-->
														<td><label><h4 style="margin:0px; display:inline-block;">FaceBook App Secret:</h4></label>
																<input type="text" value="<?php
																if(isset($meta_arr['facebook_app_secret'])) {
																	echo $meta_arr['facebook_app_secret'];
																} else {
																	$meta_arr['facebook_app_secret'] = '';
																	echo $meta_arr['facebook_app_secret'];
				...
				<br/>
				<!--<span class="ism-info" style="font-size:12px;">For a proper share and tracking the share counts on FaceBook you need to set a Facebook App ID. <strong>The FaceBook App ID is mandatory for "Social Locker" and "Custom Content Share" feature and also for Facebook Messenger share box!</strong>. For a Standard Share Action it's <strong>NOT</strong> requested.</span>-->
				<span class="ism-info" style="font-size:12px;">For a proper share and tracking the share counts on FaceBook you need to set a FaceBook App ID and FaceBook App Secret . <strong>The FaceBook App ID and FaceBook App Secret is mandatory for "Social Locker" and "Custom Content Share" feature and also for FaceBook Messenger share box!</strong>.</span>
		...
		<div class="stuffbox-ism" style="display: none;">
            <h3>
