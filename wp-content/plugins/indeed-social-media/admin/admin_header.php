	...
	<div class="ism_right_side">
		<ul>
            <?php
                ...
                $menu_items['subscribe_newsletter'] = 'Subscribe to Newsletter';              
                ...
                foreach($menu_items as $k=>$v){
					...
					if (!ISMACTIVATEDMODE && ($k=='follow' || $k=='shortcode')){
						$addon = 'ism-deactivate';
						$menu_item_lnk = '#';
					} else {
						$menu_item_lnk = $url . '&tab=' . $k;
					}

                    ?>
						<li class="<?php echo $class;?>">
							<a href="<?php echo $menu_item_lnk;?>">
...
<!-- /top menu-->
<?php if ($tab=='general_options') echo '<div style="margin-top: 40px;"></div>';?>
<?php echo ism_inside_dashboard_error_license();?>
