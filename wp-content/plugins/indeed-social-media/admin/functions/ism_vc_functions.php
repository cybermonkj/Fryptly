...
if (defined('WPB_VC_VERSION')){
	if (version_compare(WPB_VC_VERSION, '4.4')==1){
		vc_add_shortcode_param('ism_checkbox_icons', 'ism_checkbox_icons_settings_field');
		vc_add_shortcode_param('ism_dropdown_picture', 'ism_dropdown_picture_settings_field');
		vc_add_shortcode_param('ism_return_radio', 'ism_return_radio_settings_field');
		vc_add_shortcode_param('ism_return_checkbox', 'ism_return_checkbox_settings_field');
		vc_add_shortcode_param('ism_return_number', 'ism_return_number_settings_field');
		vc_add_shortcode_param('ism_return_dropdown', 'ism_return_dropdown_settings_field');
		vc_add_shortcode_param('ism_on_off', 'ism_on_off_settings_field');
		vc_add_shortcode_param('ism_show_hide', 'ism_show_hide_settings_field');
		vc_add_shortcode_param('ism_roles_select', 'ism_roles_select_settings_field');
		vc_add_shortcode_param('ism_select_referers', 'ism_select_referers_settings_field');		
	} else {
