...
if (!daftplugInstantifyPwa::isOnesignalActive()) { ?>
    <link rel="manifest" href="<?php echo $this->getManifestUrl(false); ?>">
<?php }

$appIcon = (has_site_icon()) ? get_site_icon_url(192) : preg_replace('/(\.[^.]+)$/', sprintf('%s$1', '-192x192'), wp_get_attachment_image_src(daftplugInstantify::getSetting('pwaIcon'), 'full')[0]);
?>
