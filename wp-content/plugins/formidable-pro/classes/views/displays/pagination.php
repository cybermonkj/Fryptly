...
<?php
	...
	?>
<li class="<?php echo esc_attr( apply_filters( 'frm_prev_page_class', '', $atts ) ) ?>"><a href="<?php
	echo esc_url(
		apply_filters(
			'frm_prev_page_link',
	...
	?>" class="prev"><?php echo apply_filters('frm_prev_page_label', '&#171;', $atts ) ?></a></li> <?php
    }

    // First page is always displayed
?>
<li class="<?php echo ( $current_page == 1 ) ? 'active' : '' ?>"><a href="<?php
	echo esc_url(
		apply_filters(
			'frm_first_page_link',
...
<li class="<?php echo esc_attr( apply_filters( 'frm_page_dots_class', 'dots disabled', $atts ) ); ?>">...</li> <?php
	...
	?>
<li class="<?php echo esc_attr( $current_page == $i ? 'active' : '' ) ?>"><a href="<?php
	echo esc_url(
		apply_filters(
			'frm_page_link',
...
?>
<li class="<?php echo esc_attr( $current_page == $page_count ? 'active' : '' ) ?>"><a href="<?php
	echo esc_url(
		apply_filters(
			'frm_last_page_link',
	...
	?>"><?php echo absint( $page_count ); ?></a></li><?php

    // Display the next page icon if there is a next page
	if ( $current_page < $page_count ) {
	?>
<li class="<?php echo esc_attr( apply_filters( 'frm_next_page_class', '', $atts ) ); ?>"><a href="<?php
	echo esc_url(
		apply_filters(
			'frm_next_page_link',
			add_query_arg( array( $page_param => $current_page + 1 ) ) . $page_params,
	...
	?>" class="next"><?php echo apply_filters( 'frm_next_page_label', '&#187;', $atts ) ?></a></li><?php
	}
	?>
</ul>
</div>
