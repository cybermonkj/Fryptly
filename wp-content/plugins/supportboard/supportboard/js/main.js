    ...
    $(document).ready(function () {
        ...
        if (main.length && typeof SB_AJAX_URL != ND) {
            ...
            SBF.ajax({
                ...
                if (!admin && !CHAT_SETTINGS['chat-manual-init'] && (!CHAT_SETTINGS['disable-offline'] || agents_online) && (!CHAT_SETTINGS['disable-office-hours'] || CHAT_SETTINGS['office-hours']) && (!CHAT_SETTINGS['chat-login-init'] || (!SBApps.is('wp') && SBF.cookie('sb-login')) || (SBApps.is('wp') && SBApps.isLoggedWP()))) {
                    SBChat.initChat();
                }
