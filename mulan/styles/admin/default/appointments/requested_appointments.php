<div class="page-title">
    ...
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1" >
            ...
            <li class="active">
                <strong><?= lang('global_requested_appointments') ?></strong>
            </li>
        </ol>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"> <?= lang('global_requested_appointments') ?></h3>
    ...
    <div class="panel-body">
        ...
        <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk" data-sticky-table-header="true" data-add-display-all-btn="true" data-add-focus-btn="true">
            <table cellspacing="0" class="table table-small-font table-bordered table-striped" >
                <thead>
                    <tr>
                        <th> <?= lang('global_subject') ?></th>
                        <th> <?= lang('global_name') ?></th>
                        <th> <?= lang('global_appointments') ?></th>
                ...
                <tbody class="middle-align">
                    <?php foreach ($items as $item): ?>
                        <tr id="<?php echo $item->requested_appointment_id ?>">
                            <td><?php echo $item->subject ?></td>
                            <td><?php echo $item->name ?></td>
                            <td><?php echo $item->date ?> - <?php echo $item->time ?></td>
                            <td><?php echo $item->created ?></td>
                            <td>
                                <a href="<?php echo site_url('admin/requested_appointments/view/' . $item->requested_appointment_id); ?>" class="btn btn-orange btn-sm">
...
<script type="text/javascript">
    $(".remove").click(function(){
        ...
        {
            $.ajax({
               url: '<?php echo site_url() ?>admin/requested_appointments/delete/'+id,
               type: 'DELETE',
               error: function() {
