                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="v-about">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <?php if ($item->resume): ?>
                                    <a href="<?php echo base_url() ?>/cdn/about/<?php echo $item->resume ?>" download target="_blank"><i class="fa fa-download"></i> <?php echo lang('global_Download_Resume') ?></a>
                                <?php endif ?>
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
                    ...
                    <div class="tab-pane" id="v-social">
                        ...
                        <div class="form-group-separator"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="field-1"> <?php echo lang('global_whatsapp') ?></label>
                            <div class="col-sm-10">
                                <?php echo form_input('about[whatsapp]', set_value('about[whatsapp]', $item->whatsapp), 'class="bg-focus form-control"') ?>
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
                    </div>
