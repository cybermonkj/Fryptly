                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-icon">
                                            ...
                                            <input name="date" id="app_date" type="text" data-lock="from" data-init-set="false"  <?php if (config('language') == 'english'): ?>data-lang="en"<?php elseif (config('language') == 'arabic'): ?>data-lang="ar" <?php endif ?> data-large-mode="true" data-large-default="true" data-min-year="2020" data-max-year="2020" placeholder="<?php echo lang('global_date') ?>" required autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-icon">
