                ...
                if (!empty($orders_status)) {
                    foreach ($orders_status as $value) {
                        ...
                        if (!empty($api)) {
                            ...
                            if (in_array($item['status'], ['Cancelled', 'canceled', 'Canceled', 'Refunded', 'refunded']) && $value->charge != '0') {
                            ...
                            if (in_array($item['status'], ['Partial', 'partial']) && $value->charge != '0' && $item['remains'] <= $value->quantity) {
