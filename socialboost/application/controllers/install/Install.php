		...
		if (isset($_POST) && !empty($_POST)) {
			...
			if (empty($purchase_code)) {
				json([
					...
					'type' => 'error',
					'message' => 'Please place your Purchase Code',
				]);
			}
			...
			setup_install($purchase_code, $host, $db_user, $db_password, $db_name, $name, $username, $email, $password, $timezone);
		}
	}
}
