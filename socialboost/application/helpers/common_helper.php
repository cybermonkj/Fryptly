...
if (!function_exists('verifyPayments')) {
    ...
    {
        if (config_payment('paypal_status', 'value') == 'off' && config_payment('pagseguro_status', 'value') == 'off' && config_payment('mercadopago_status', 'value') == 'off' && config_payment('stripe_status', 'value') == 'off' && config_payment('2checkout_status', 'value') == 'off' && config_payment('coinpayments_status', 'value') == 'off' && config_payment('skrill_status', 'value') == 'off' && config_payment('payumoney_status', 'value') == 'off' && config_payment('manual_status', 'value') == 'off') return true;
    }
}
