...
// Dashboard
$route['dashboard'] = 'panel/dashboard/dashboard/index';
$route['dashboard/(:num)'] = 'panel/dashboard/dashboard/index/$1';
...
// About
$route['admin/about'] = 'panel/admin/management/about/index';
$route['admin/about/update'] = 'panel/admin/management/about/checkupdate';
