...
define("TABLE_CONFIG", 'configs');
define("TABLE_TICKETS", 'tickets');
define("TABLE_TICKET_MESSAGES", 'ticket_messages');
define("TABLE_LOGS", 'logs');
define("TABLE_LANG", 'lang');
define("TABLE_LANG_LIST", 'lang_list');
define("TABLE_CATEGORIES", "categories");
define("TABLE_API_PROVIDERS", "api_providers");
...
define("TABLE_PAYMENTS_CONFIG", "payments_integrations");
define("TABLE_TRANSACTION_LOGS", "transaction_logs");
