		...
		<div class="row">
			<div class="col-md-8 round align-items-center justify-content-center mx-auto">
				<div class="card border-0">
					<div class="card-body">
						<h6 class="bg-dark text-white p-2 rounded font-weight-bold">Item Purchase Code</h6>
						<div class="form-group">
							<?php
							echo form_label("Purchase Code <span class='text-danger font-weight-normal'>*</span>", 'purchase_code', [
							...
							echo form_input([
								...
								'class' => 'form-control',
								'type' => 'text',
								'value' => set_value("purchase_code"),
								'placeholder' => 'Item Purchase Code'
							]);
							?>
						</div>
