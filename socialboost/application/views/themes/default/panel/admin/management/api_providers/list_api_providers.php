					...
					<tbody>
						...
						?>
							<tr>
								...
								<td class="border"><a href="<?= $only_url; ?>" target="_blank" class="text-decoration-none" id="name_api<?= $value->id; ?>"><?= (strlen($value->name) >= 17) ? substr($value->name, 0, 17) . '...' : $value->name; ?></a>
								</td>
