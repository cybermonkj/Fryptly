...
<head>
    ...
    <meta name="keywords" content="<?= configs('meta_keywords', 'value'); ?>">
...
<body>
    <?php if (in_array(uri(1), ['dashboard'])) : ?>
        <div class="preloader">
            <div class="loader">
            ...
            <div class="row align-items-center">
                <div class="col-sm-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <a class="navbar-brand mx-auto" href="<?= base_url('dashboard'); ?>"><img src="<?= set_image('logo_white.png'); ?>" class="logo" alt="logo"></a>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white border-shadow">
            ...
            <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                <ul class="navbar-nav align-items-center font-weight-normal mx-auto">
                    <li class="nav-item">
                        <a class="nav-link <?= active_menu('dashboard'); ?>" href="<?= base_url('dashboard'); ?>"><i class="fa fa-dashboard"></i> <?= lang("menu_dashboard"); ?></a>
                    </li>
                    ...
                    <?php /** Type of account: ADMIN */ if (userLevel(logged(), 'admin')) : ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuAdmin">
                                ...
                                <h5 class="dropdown-header fs-15 bg-secondary text-white"><?= lang("menu_system"); ?></h5>
                                <a class="dropdown-item <?= active_menu('admin/about'); ?>" href="<?= base_url("admin/about"); ?>"><?= lang("menu_about"); ?> <?= (verify_update_boostpanel() ? '<span class="badge badge-green fs-12">' . lang("update_available") . '</span>' : ''); ?></a>
                            </div>
                        </li>
                    <?php endif;
